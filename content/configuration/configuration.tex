...
\firstSupervisor{Prof. Dr. Thomas, Lehmann}
\secondSupervisor{}    % only if needed, otherwise left blank

% text field
%-> replace title with your title of the seminar work
\termPaperTitle{Architekturentwicklung und Threat Modelling eines Multi-Agenten-Systems}
%\termPaperTitleEN{A Gamebot }

% text field
%-> replace the key words with your own key words or remove the words
\keywordsDE{KI-Agenten, Multi-Agent-Systeme, Threats}
\keywordsEN{KI-Agents, multi-agent-system, threats}
